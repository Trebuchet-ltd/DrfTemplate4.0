...
# EMAIL_USE_SSL = True
EMAIL_PORT = 587
EMAIL_HOST_USER = "adithyanandakumar10@gmail.com"
EMAIL_HOST_PASSWORD = "vdjajglrreojqnsx"
...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        # model admin to link to (Permissions checked against model)
        {"model": "auth.User"},
        {"name": "logs", "url": f"/admin/log_viewer/"},
        {"name": "requests", "url": f"/admin/request-viewer/"},
        # App with dropdown menu to all its models pages (Permissions checked against models)
        {"app": "home"},
    ],
